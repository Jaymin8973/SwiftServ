    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            try {
                ...
                setLoading(true);
                const response = await axios.post('http://192.168.1.4:3000/payment-cards/add', payload);
            ...
            <SafeAreaView className="flex-1">
                ...
                >
                    <ScrollView contentContainerStyle={{ flexGrow: 1, marginHorizontal: 20, justifyContent: 'flex-start' }}>
                        ...
                        <View className="gap-10">
                            <View className="h-60 justify-center rounded-2xl bg-[#09A3C5]">
                                <View>
                                    <Image source={{ uri: cardLogos['Visa'] }} style={{ width: 80, height: 50, resizeMode: 'contain', position: 'absolute', top: 10, right: 10 }} />
                                </View>

                                <View className="flex-1 items-center justify-end">
                                    <Text className="text-white text-2xl" style={{ letterSpacing: 5 }}>**** **** **** ****</Text>
                                </View>
                                <View className="p-5 flex-1 justify-end">
                                    <View className="flex-row justify-between items-center">
                                        <View>
                                        ...
                                        <View>
                                            <Text className="text-white text-md font-bold">VALID THRU</Text>
                                            <Text className="text-white text-lg text-right">MM/YY</Text>
                                        </View>
                                    </View>
                                </View>
                            </View>
                            <View className="gap-10">
                                <View className="gap-2">
                                    <Text className="text-lg font-bold">Cardholder Name</Text>
                                    <TextInput className="border-b border-gray-400 text-lg pb-2" placeholder="Enter Name" placeholderTextColor="gray" />
                                </View>

                                <View className="gap-2">
                                    <Text className="text-lg font-bold">Card Number</Text>
                                    <TextInput className="border-b border-gray-400 text-lg pb-2" placeholder="Enter Card Number" placeholderTextColor="gray" keyboardType="numeric" maxLength={16}
                                    />
                                </View>
                                ...
                                <View className="flex-row justify-between gap-4">
                                    <View className="gap-2 w-1/2">
                                        <Text className="text-lg font-bold">Expiry Date</Text>
                                        <TextInput className="border-b border-gray-400 text-lg pb-2" placeholder="MM/YY" placeholderTextColor="gray" keyboardType="numeric" maxLength={5}
                                        />
                                    </View>
